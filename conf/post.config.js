...
module.exports = {
  ...
  LATEST_POST_COUNT: process.env.NEXT_PUBLIC_LATEST_POST_COUNT || 5, // 最新文章数量
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE || 12, // post counts per page
  POSTS_SORT_BY: process.env.NEXT_PUBLIC_POST_SORT_BY || 'date', // 排序方式 'date'按时间,'notion'由notion控制*************值得注意！
