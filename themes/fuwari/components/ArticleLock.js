    ...
    <div className='fuwari-card p-6 md:p-8 text-center'>
      ...
      <div className='max-w-sm mx-auto flex'>
        <input
          ...
          className='flex-1 rounded-l-xl border bg-[var(--fuwari-bg-soft)] px-4 py-2 text-sm outline-none'
          style={{
            borderColor: 'var(--fuwari-border)',
          }}
          onFocus={(e) => e.target.style.borderColor = '#EF4D5B'}
          onBlur={(e) => e.target.style.borderColor = 'var(--fuwari-border)'}
